...
public class Turma {
    ...
    public Turma buscarTurma(int codTurma) throws IOException {
    ...
    public void listarTurmas() throws IOException {
        ...
        while ((linha = reader.readLine()) != null) {
            ...
            List<Professor> professores = new ArrayList<>();
            String[] listaProfessores = campos[4].split(", ");
            for (String professor : listaProfessores) {
                Professor p = new Professor();
                p.setNome(professor);
                professores.add(p);
            }
            Turma turma = new Turma(Integer.parseInt(campos[0]), Integer.parseInt(campos[1]), Integer.parseInt(campos[2]), horarios, professores);
    ...
    public void listarTurmasPorProfessor(int identificacao) throws IOException {
        ...
        System.out.printf("%-10s%-30s%-20s%-30s\n", "Código", "Horários", "Semestre", "Professores");
    ...
    public void listarTurmasPorSemestre(int semestre) throws IOException {
        ...
        System.out.printf("%-15s %-10s %-20s %-30s %-30s%n", "Código Turma", "Semestre", "Dias de Aula na Semana", "Horários", "Professores");
